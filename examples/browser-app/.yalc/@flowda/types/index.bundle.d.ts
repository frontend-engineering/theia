...
declare const AssociationKeySchema: z.ZodObject<{
    key_type: z.ZodLiteral<"association">;
    display_name: z.ZodString;
    slug: z.ZodString;
    model_name: z.ZodString;
    foreign_key: z.ZodString;
...
declare const ReferenceKeySchema: z.ZodObject<{
    key_type: z.ZodLiteral<"reference">;
    display_name: z.ZodString;
    model_name: z.ZodString;
...
declare const ResourceKeySchema: z.ZodObject<{
    key_type: z.ZodLiteral<"resource">;
    name: z.ZodString;
    slug: z.ZodString;
...
type UISchemaObject = ResourceKey | ColumnKey | AssociationKey | ReferenceKey;
...
declare const ResourceUISchema: z.ZodObject<Omit<{
    ...
    required: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
}, "required" | "key_type" | "properties">, "strip", z.ZodTypeAny, {
    name: string;
    primary_key: string | null;
    display_name: string;
    slug: string;
...
declare const ColumnUISchema: z.ZodObject<{
    ...
    reference: z.ZodOptional<z.ZodObject<Omit<{
        key_type: z.ZodLiteral<"reference">;
        display_name: z.ZodString;
        model_name: z.ZodString;
        reference_type: z.ZodUnion<[z.ZodLiteral<"belongs_to">, z.ZodLiteral<"has_one">]>;

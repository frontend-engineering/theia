...
let NewForm = class NewForm extends Component {
    render() {
        return (_jsx(Formik, { onSubmit: values => {
                ...
                return (_jsxs(EuiThemeProvider, { colorMode: this.props.model.theme.colorMode, children: [_jsx(NewFormToolbar, { model: this.props.model }), _jsx(FEuiHorizontalRule, {}), _jsx(Box, { mx: 3, children: _jsx(EuiForm, { isInvalid: false, error: [], component: "form", children: this.props.model.formItemColumns == null ? null : (_jsx(EuiFlexGrid, { columns: 3, children: this.props.model.formItemColumns.map(col => {

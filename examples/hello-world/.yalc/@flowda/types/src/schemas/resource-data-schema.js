...
exports.putResourceDataInputSchema = exports.getResourceDataOutputSchema = exports.getResourceDataOutputInnerSchema = exports.getResourceDataInputSchema = exports.findUniqueResourceDataInputSchema = exports.findManyResourceDataInputSchema = exports.getResourceInputSchema = void 0;
const zod_1 = require("zod");
const ag_grid_schema_1 = require("./ag-grid-schema");
exports.getResourceInputSchema = zod_1.z.object({
    schemaName: zod_1.z.string(),
});
exports.findManyResourceDataInputSchema = zod_1.z.object({
    schemaName: zod_1.z.string(),
...
exports.findUniqueResourceDataInputSchema = zod_1.z.object({
    schemaName: zod_1.z.string(),
    id: zod_1.z.number(),
});
exports.getResourceDataInputSchema = zod_1.z.union([
    exports.findManyResourceDataInputSchema,
    exports.findUniqueResourceDataInputSchema
]);
